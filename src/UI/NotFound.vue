...
<template>
  <!-- <div class="text-center">
    <h2 style="text-align: center">No page found!</h2>
    <h3>
      Do you want to <router-link to="/">Start again</router-link>...?
    </h3>
  </div> -->
        ...
        <div class="error">
            <div class="container-floud">
                <div class="col-xs-12 ground-color text-center">
                    ...
                    <h2 class="h1">Sorry! Page not found  <router-link to="/">Start again</router-link></h2>
                </div>
            </div>
        </div>
    <!-- Error Page -->
